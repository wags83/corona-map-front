google.charts.load('current', {packages: ['geochart', 'corechart'], 'mapsApiKey': ['MAPSAPIKEY']}); //load different packages for timeseries?
...
const getCountryData = () => {
    ...
    .then(countries => {
        ...
        countries.forEach(country => {
            ...
            let map_row = [country.name, country.days[lastDay].cases];
            let modal_row = [country.name, country.days[lastDay].cases, country.days[lastDay].deaths, country.days[lastDay].recovered, country.id];
